...
namespace BJ.DataAccess.Migrations
{
    ...
    [Migration("20190409152213_fixDBRenameSteps")]
    partial class fixDBRenameSteps
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BJ.DataAccess.Entities.Bot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BJ.DataAccess.Entities.BotInGame", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BJ.DataAccess.Entities.Game", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BJ.DataAccess.Entities.StepUser", b =>
                {
                    ...
                    b.HasOne("BJ.DataAccess.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BJ.DataAccess.Entities.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
